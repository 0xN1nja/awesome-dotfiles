    ...
    <section className="grid gap-8 pt-6 sm:gap-4 md:grid-cols-[5fr_5fr]" aria-label="About">
      <div className="order-2 space-y-3 sm:order-1">
        ...
        <p className={typo({ variant: "paragraph", font: "sans" })}>
          ...
          <Link href="/rices" prefetch={false} className="el-focus-styles text-ring underline">
            a click away
          </Link>
          .
        </p>
        ...
        <p className={typo({ variant: "paragraph", font: "sans" })}>
          ...
          <Link href="/about" prefetch={false} className="el-focus-styles text-ring underline">
